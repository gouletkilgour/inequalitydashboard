...
#
# This script writes gini.html into the same directory it lives in
# (website/data/), already styled to match the rest of the Inequality
# Dashboard site (shared header/breadcrumb, theme colors via style.css,
# Chart + Provincial Rankings side by side with About this data below).
# Re-running it regenerates a ready-to-publish page — no manual reskin step.
# -----------------------------------------------------------------------------
...
<head>
  ...
  <title>Gini Coefficients &mdash; Inequality Dashboard</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #rank-year:focus { border-color: var(--accent); }
...
<div class="page" style="padding-bottom: 1rem;">
  ...
  <h2 class="post-title">Gini Coefficients of Adjusted Income</h2>
</div>
