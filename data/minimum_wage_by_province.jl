...
<main class="page" style="padding: 1.5rem 1.5rem;">
  ...
  <section id="rankings">
    ...
    <div class="rank-controls">
      ...
      <span class="rank-ctrl-label">Drag the slider to see the ranking on a different date &mdash; click a province to highlight it in the chart</span>
    </div>
  ...
  <section class="about-section">
    <div class="prose">
      ...
      <p>
        The <strong>general (basic adult) minimum hourly wage</strong> in each of Canada's ten provinces, plus their unweighted average, from January 1, 1974 &mdash; the date every province has a comparable general rate &mdash; through the present. The average line is shown by default; click any province, or a row in the ranking list, to highlight it instead. Drag the ranking panel's date slider to see how the provinces ranked at an earlier point in time; the chart itself always shows the full history regardless of the slider.
      </p>
      ...
      <ul>
        ...
        <li><strong>The chart displays every province from January 1, 1974 onward</strong> &mdash; Prince Edward Island's start date, the latest of the ten &mdash; even though most provinces' sourced record (above) goes back further, so every province is shown over the same span and is directly comparable. For a province whose record starts earlier, the displayed series' first point holds whatever rate was already in effect on January 1, 1974 (noted on hover); no earlier data is discarded, only left out of this display.</li>
