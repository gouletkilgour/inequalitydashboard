...
#
# This script writes income_shares.html into the same directory it lives in
...
<head>
  ...
  <title>Income Shares &mdash; Inequality Dashboard</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #rank-year:focus, #rank-group:focus { border-color: var(--accent); }
...
<div class="page" style="padding-bottom: 1rem;">
  ...
  <h2 class="post-title">Income Shares</h2>
</div>
